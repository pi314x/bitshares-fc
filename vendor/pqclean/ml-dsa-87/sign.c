...
/*************************************************
* Name:        PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair_derand
*
...
* Returns 0 (success)
**************************************************/
int PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair_derand(uint8_t *pk, uint8_t *sk,
...
int PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair(uint8_t *pk, uint8_t *sk) {
    ...
    return PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair_derand(pk, sk, seed);
}
...
**************************************************/
int PQCLEAN_MLDSA87_CLEAN_crypto_sign_signature_ctx_derand(uint8_t *sig,
        size_t *siglen,
        const uint8_t *m,
        size_t mlen,
        const uint8_t *ctx,
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_CLEAN_crypto_sign_signature_ctx
*
...
int PQCLEAN_MLDSA87_CLEAN_crypto_sign_signature_ctx(uint8_t *sig,
    ...
    return PQCLEAN_MLDSA87_CLEAN_crypto_sign_signature_ctx_derand(sig, siglen, m, mlen, ctx, ctxlen, rnd, sk);
}
