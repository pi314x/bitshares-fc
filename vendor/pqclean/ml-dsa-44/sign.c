...
**************************************************/
int PQCLEAN_MLDSA44_CLEAN_crypto_sign_signature_ctx_derand(uint8_t *sig,
        size_t *siglen,
        const uint8_t *m,
        size_t mlen,
        const uint8_t *ctx,
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_CLEAN_crypto_sign_signature_ctx
*
...
int PQCLEAN_MLDSA44_CLEAN_crypto_sign_signature_ctx(uint8_t *sig,
    ...
    return PQCLEAN_MLDSA44_CLEAN_crypto_sign_signature_ctx_derand(sig, siglen, m, mlen, ctx, ctxlen, rnd, sk);
}
